...
const TeamCard = () => {
  return (
    <div className="bg-gradient-to-r from-primary to-secondary p-0.5 rounded-[12px] relative">
      <div className="flex flex-col w-[295px] h-[325px] justify-evenly items-center rounded-[12px] bg-base-100">
        {/* ----- Img + Text ----- */}
        <div className="flex justify-around items-center w-full">
          ...
          <div className="w-2/5">
            <h1 className="text-white">Abbas Khan</h1>
            <p className="text-white opacity-60 pl-0.5">Role Less</p>
          </div>
        </div>
        {/* ------ Icons ----- */}
